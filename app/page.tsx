  ...
  return (
    <main className="bg-gray-100 h-screen flex items-center justify-center p-5 ">
      <div className="flex flex-col gap-2 bg-white shadow-lg p-5 rounded-3xl w-full max-w-sm ">
        <input
          className="w-full rounded-full h-12 bg-gray-100 pl-5 outline-none ring ring-transparent focus:ring-orange-500 focus:ring-offset-2 transition-shadow placeholder:drop-shadow"
          type="text"
